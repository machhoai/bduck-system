...
export enum AuditAction {
  ...
  TRANSFER = "TRANSFER",
  EXPORT = "EXPORT",
  MARKETING_VOUCHER_CAMPAIGN_CREATE = "MARKETING_VOUCHER_CAMPAIGN_CREATE",
  MARKETING_VOUCHER_CAMPAIGN_UPDATE = "MARKETING_VOUCHER_CAMPAIGN_UPDATE",
  MARKETING_VOUCHER_CAMPAIGN_STATUS = "MARKETING_VOUCHER_CAMPAIGN_STATUS",
  MARKETING_VOUCHER_CAMPAIGN_SOFT_DELETE = "MARKETING_VOUCHER_CAMPAIGN_SOFT_DELETE",
  MARKETING_VOUCHER_CODES_GENERATE = "MARKETING_VOUCHER_CODES_GENERATE",
  MARKETING_VOUCHER_CODES_REVOKE = "MARKETING_VOUCHER_CODES_REVOKE",
  MARKETING_VOUCHER_EXPIRY_EXTEND = "MARKETING_VOUCHER_EXPIRY_EXTEND",
  MARKETING_VOUCHER_APPEARANCE_UPDATE = "MARKETING_VOUCHER_APPEARANCE_UPDATE",
  MARKETING_VOUCHER_EMAIL_JOB_CREATE = "MARKETING_VOUCHER_EMAIL_JOB_CREATE",
  MARKETING_VOUCHER_EMAIL_ITEM_SEND = "MARKETING_VOUCHER_EMAIL_ITEM_SEND",
  MARKETING_VOUCHER_EMAIL_ITEM_RETRY = "MARKETING_VOUCHER_EMAIL_ITEM_RETRY",
  MARKETING_VOUCHER_EXPORT_JOB_CREATE = "MARKETING_VOUCHER_EXPORT_JOB_CREATE",
  MARKETING_VOUCHER_EXPORT_PART_CREATE = "MARKETING_VOUCHER_EXPORT_PART_CREATE",
  MARKETING_VOUCHER_EXPORT_COMPLETE = "MARKETING_VOUCHER_EXPORT_COMPLETE",
  MARKETING_VOUCHER_EXPORT_FAILED = "MARKETING_VOUCHER_EXPORT_FAILED",
  MARKETING_VOUCHER_EXPORT_DOWNLOAD = "MARKETING_VOUCHER_EXPORT_DOWNLOAD",
  MARKETING_VOUCHER_JOB_RESUME = "MARKETING_VOUCHER_JOB_RESUME",
  MARKETING_VOUCHER_MIGRATION_RUN = "MARKETING_VOUCHER_MIGRATION_RUN",
}
