...
export const createEmptyAssignment = (): AssignmentDraft => ({
  warehouse_id: "",
  role_id: "",
  ...
  return (
    <section className="space-y-3">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          onClick={() => onChange([...assignments, createEmptyAssignment()])}
        ...
        {assignments.map((assignment, index) => (
          ...
          >
            ...
            <DateField
              ...
              onChange={(value) => updateAssignment(index, "valid_until", value)}
            />
