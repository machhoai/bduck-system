    ...
    function AccessSummaryCard({
        ...
        return (
            <button
                type="button"
                onClick={onClick}
                className={`min-h-32 rounded-[var(--radius-lg)] border bg-white p-4 text-left transition-all active:scale-[0.99] ${active
            ...
            >
                <div className="flex items-start justify-between gap-4">
                    ...
                    <span
                        className={`rounded-full border px-3 py-1 text-xs font-semibold ${canWrite
