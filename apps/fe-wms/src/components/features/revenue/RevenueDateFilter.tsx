            ...
            {modeKeys.map((mode) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() => update({ mode })}
                  className={`h-8 flex-1 shrink-0 rounded-[var(--radius-sm)] px-3 text-xs font-semibold transition-all duration-150 ${
                    active
          ...
          {showComparison && (
            <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2 border-t border-[var(--color-border-subtle)] pt-2 md:border-l md:border-t-0 md:pl-2 md:pt-0">
              <button
                ...
                className={`inline-flex h-8 shrink-0 items-center gap-2 rounded-[var(--radius-sm)] px-2.5 text-xs font-semibold transition-all duration-150 ${
                  comparisonEnabled
                    ? "bg-[var(--color-brand-primary)] text-white shadow-sm"
