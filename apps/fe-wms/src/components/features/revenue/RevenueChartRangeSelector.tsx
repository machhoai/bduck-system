...
export default function RevenueChartRangeSelector({
  ...
  return (
    ...
    >
      <div className="grid min-w-[276px] grid-cols-4 gap-1 rounded-[var(--radius-md)] bg-[var(--color-surface-card)] p-1 ring-1 ring-[var(--color-border-subtle)]">
        {OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`min-h-9 whitespace-nowrap rounded-[var(--radius-sm)] px-2 text-xxs font-semibold transition-colors sm:min-h-8 ${
                selected
