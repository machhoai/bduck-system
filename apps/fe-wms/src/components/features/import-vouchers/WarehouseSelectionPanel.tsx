...
const COPY = {
    vi: {
        ...
        webGlErrorMessage: "Trình duyệt của bạn không hỗ trợ WebGL hoặc tính năng tăng tốc phần cứng đang bị tắt.",
    },
    zh: {
        warehouse: "收货仓库",
    ...
    return (
        <section className="overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)]">
            <div className="flex items-center justify-between border-b border-[var(--color-border-subtle)] px-4 py-3">
                ...
                {coordinate && (
                    <span className="rounded-full bg-[var(--color-brand-primary-muted)] px-2 py-1 text-[10px] font-semibold text-[var(--color-brand-primary)]">
            ...
            <div className="relative h-56 bg-[var(--color-surface-card)] sm:h-64 lg:h-[340px]">
                {webGlError ? (
                    <div className="flex h-full flex-col items-center justify-center bg-[var(--color-surface-card)] p-6 text-center">
                        <MapPin size={40} className="mx-auto mb-3 text-[var(--color-text-muted)] opacity-50" />
                    ...
                    >
                        <Marker
                            ...
                            anchor="bottom"
                        >
                            <div className="flex h-10 w-10 items-center justify-center rounded-full border-4 border-white bg-[var(--color-brand-primary)] text-white shadow-lg">
                                ...
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        {isSelected ? (
                                            ...
                                            <span
                                                className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-semibold ${isActive
