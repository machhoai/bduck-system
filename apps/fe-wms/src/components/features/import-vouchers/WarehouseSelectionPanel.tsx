...
function WarehouseMapPreview({
    ...
    return (
        <section className="overflow-hidden relative rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)]">
            <div className="flex absolute top-2 left-2 z-10 items-center justify-between rounded-2xl px-4 py-2 bg-white">
            ...
            {warehouse && (
                <div className="absolute bottom-2 right-2 z-10 w-fit gap-3 flex p-2 rounded-full bg-[var(--color-brand-primary-muted)] px-2 py-1 text-xxs font-semibold text-[var(--color-brand-primary)]">
                                ...
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        {isSelected ? (
                                            ...
                                            <span
                                                className={`shrink-0 rounded-full px-2 py-0.5 text-xxs font-semibold ${isActive
