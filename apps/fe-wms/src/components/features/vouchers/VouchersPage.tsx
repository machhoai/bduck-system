                ...
                <div className="flex items-center h-full gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                        <h1 className="text-lg font-bold tracking-normal text-[var(--color-text-primary)]">
                            {t.vouchers?.title || "Quản lý Lệnh / Phiếu"}
                        </h1>
                        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
                            {t.vouchers?.subtitle || "Theo dõi và tạo phiếu Nhập, Xuất, và Điều chuyển"}
                        </p>
                    </div>
                </div>
                ...
                <div className="sticky top-[88px] z-20 lg:static">
                    <div className="flex items-center border-b border-[var(--color-border-subtle)]">
                        {visibleTabs.map((tab) => {
                            ...
                            const label = t.vouchers?.tabs?.[tab.labelKey] || t.importVoucher?.tabs?.[tab.labelKey] || tab.labelKey;
