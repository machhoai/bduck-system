...
import { MenuBadgesProvider } from "../providers/MenuBadgesProvider";
  ...
  return (
    <MenuBadgesProvider>
      <div className="h-screen flex relative bg-slate-200">
        ...
        <main
          id="wms-main-content"
          className={`flex relative h-screen min-h-0 flex-col flex-1 gap-2 transition-[margin-left] pb-[var(--bottomnav-height)] duration-300 ease-in-out lg:pb-0 ${
            isCollapsed
