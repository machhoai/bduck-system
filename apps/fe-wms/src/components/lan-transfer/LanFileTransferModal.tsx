...
export default function LanFileTransferModal({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/30 p-4">
      <div className="grid max-h-[calc(100vh-32px)] w-[min(960px,calc(100vw-32px))] grid-rows-[auto_1fr] gap-3 overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] p-4 shadow-xl">
