...
function RequestCard({
    ...
    return (
        <article className="grid gap-3 rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-card)] p-3">
            ...
            {request.message && (
                <div className="grid gap-1 rounded-[var(--radius-sm)] bg-[var(--color-brand-primary-muted)] p-2">
                    <span className="flex items-center gap-1 text-xxs font-bold uppercase tracking-normal text-[var(--color-brand-primary)]">
                        <MessageSquare size={12} />
                        {t.lanTransfer.messageLabel}
                    </span>
                    <p className="line-clamp-4 whitespace-pre-wrap text-xs text-[var(--color-text-secondary)]">
                        {request.message}
                    </p>
                </div>
            )}
...
export default function LanIncomingRequests({
    ...
    return (
        <aside className="flex flex-col flex-1 min-h-0 gap-3 rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-card)] p-3">
            ...
            {transfer.incomingRequests.length === 0 ? (
                <div className="grid min-h-32 flex-1 place-items-center rounded-[var(--radius-sm)] border border-dashed border-[var(--color-border-subtle)] p-3 text-center">
                    <p className="text-xs text-[var(--color-text-muted)]">
