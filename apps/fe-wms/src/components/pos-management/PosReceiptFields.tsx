  ...
  return (
    <label className="grid gap-2 text-xs font-bold text-slate-600">
      <span className="flex items-center justify-between gap-2">
        <span>{label}</span>
        <output className="rounded-md bg-amber-50 px-2 py-1 font-mono text-[11px] text-amber-700">
          {value}
          {unit}
        </output>
      </span>
...
export function ReceiptToggle({
  ...
  return (
    <label className="relative flex min-h-16 cursor-pointer items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5">
      <span>
