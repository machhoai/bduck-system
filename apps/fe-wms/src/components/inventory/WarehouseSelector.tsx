...
export default function WarehouseSelector({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute left-0 top-full z-50 mt-1.5 min-w-[220px] overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] py-1 shadow-lg">
          ...
          <button
            ...
            className={`flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-[15px] transition-colors hover:bg-[var(--color-surface-card)] ${
              !selectedId
