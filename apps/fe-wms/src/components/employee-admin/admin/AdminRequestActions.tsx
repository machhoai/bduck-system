            ...
            {requestTypes.map((item) => {
                ...
                return (
                    <button
                        ...
                        className="flex items-center gap-3 rounded-2xl border border-[var(--color-border-soft)] bg-white p-3 text-left transition-all hover:border-[var(--color-brand-primary)] hover:bg-[var(--color-surface-card)] active:scale-[0.98]"
                    >
                        <span
