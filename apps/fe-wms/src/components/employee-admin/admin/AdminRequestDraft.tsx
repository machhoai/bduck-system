        ...
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 w-full min-w-0">
                <label className="block min-w-0">
                    ...
                    <input
                        type="date"
                        className="mt-1 h-11 w-full min-w-0 rounded-2xl border border-[var(--color-border-soft)] bg-white px-2 sm:px-3 text-xs sm:text-sm outline-none focus:border-[var(--color-brand-primary)]"
                    />
                </label>
                <label className="block min-w-0">
                    <span className="block truncate text-xs font-medium text-[var(--color-text-secondary)]">
