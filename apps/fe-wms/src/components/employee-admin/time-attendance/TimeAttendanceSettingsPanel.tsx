...
interface TimeAttendanceSettingsPanelProps {
...
export function TimeAttendanceSettingsPanel({
    labels,
    canConfigure,
    warehouses,
    users,
    ...
    onSavePolicy,
    onSaveExemptions,
}: TimeAttendanceSettingsPanelProps) {
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-8 bg-[#f8fafc] p-3 lg:gap-12 lg:bg-slate-50/20 lg:p-4 xl:grid-cols-[360px_minmax(0,1fr)]">
                <div>
