  ...
  const exportConfig = useMemo(() => {
    ...
    return {
      ...
      columns: [
        ...
        {
          header: t.products.exportColumns.category,
          key: "category_id",
          width: 35,
          format: (val: string) => categoryById.get(val)?.name || val,
        },
        ...
        {
          header: t.products.exportColumns.type,
          key: "product_type",
          width: 20,
        },
        {
          header: t.products.exportColumns.origin,
          key: "product_origin",
          width: 20,
        },
        {
          header: t.products.exportColumns.material,
          key: "product_material",
          width: 20,
        },
        { header: t.products.exportColumns.hsCode, key: "hs_code", width: 18 },
        {
          header: t.products.exportColumns.technicalSpecifications,
          key: "technical_specifications",
          width: 35,
        },
        {
          header: t.products.exportColumns.dimensions,
          key: "dimensions",
          width: 20,
        },
        {
          header: t.products.exportColumns.manufacturer,
          key: "manufacturer",
          width: 25,
        },
        {
          header: t.products.exportColumns.manufacturerAddress,
          key: "manufacturer_address",
          width: 35,
        },
        { header: t.products.exportColumns.notes, key: "notes", width: 30 },
        {
          header: t.products.exportColumns.applicableStandard,
          key: "applicable_standard",
          width: 25,
        },
        { header: t.products.exportColumns.unit, key: "unit", width: 15 },
        {
          header: t.products.exportColumns.price,
          key: "unit_price",
          width: 15,
        },
        {
          header: t.products.exportColumns.isSerialized,
          key: "is_serialized",
          width: 20,
          format: (val: boolean) =>
            val ? t.products.exportColumns.yes : t.products.exportColumns.no,
        },
        {
          header: t.products.exportColumns.description,
          key: "description",
          width: 30,
        },
        {
          header: t.products.exportColumns.isDeleted,
          key: "is_deleted",
          width: 15,
          format: (val: boolean) =>
            val
              ? t.products.exportColumns.deleted
              : t.products.exportColumns.active,
        },
        {
          header: t.products.exportColumns.createdAt,
          key: "created_at",
          width: 25,
          format: formatExportDate,
        },
        {
          header: t.products.exportColumns.updatedAt,
          key: "updated_at",
          width: 25,
          format: formatExportDate,
        },
