...
function MetricCard({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-[var(--radius-sm)] border border-[var(--color-border-soft)] bg-[var(--color-surface-pearl)] p-3">
...
export function ProductDetailSummaryPanel({
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-border-soft)] bg-[var(--color-surface-card)]">
      ...
      <div className="grid grid-cols-2 gap-2">
        <MetricCard label={labels.totalStock} value={stockSummary.total} />
