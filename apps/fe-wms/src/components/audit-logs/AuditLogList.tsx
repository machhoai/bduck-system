import { ChevronRight, FileClock, MapPinned, UserRound, Warehouse } from "lucide-react";
                        ...
                        <span className="min-w-0">
                            ...
                            <span className="mt-2 grid gap-2 text-sm text-[var(--color-text-muted)] sm:grid-cols-2">
                                ...
                                {log.warehouse_id && (
                                    <span className="flex min-w-0 items-center gap-1.5">
                                        <Warehouse size={14} />
                                        <span className="shrink-0">{labels.warehouseId}:</span>
                                        <span className="truncate text-[var(--color-text-secondary)]">
                                            {presentation.warehouseName || log.warehouse_id}
                                        </span>
                                    </span>
                                )}
                                <span className="truncate">
