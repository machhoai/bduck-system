...
export const WAREHOUSE_EXPORT_MODAL_TEXT = {
  vi: {
    ...
    dailySummary: "Xuất nhập tồn theo ngày",
    counterDailySummary: "Xuất nhập tồn theo quầy",
    imports: "Nhập kho",
    exports: "Xuất kho",
    date: "Ngày",
    month: "Tháng",
    ...
    productSearch: "Tìm theo tên, mã, barcode, chất liệu, mô tả...",
    category: "Danh mục",
    ...
    serialized: "Serial tracking",
    allSerialized: "Tất cả",
    serializedOnly: "Có serial",
    standardOnly: "Không serial",
    unit: "Đơn vị",
    allUnits: "Tất cả đơn vị",
    material: "Chất liệu",
    allMaterials: "Tất cả chất liệu",
    location: "Quầy",
    allLocations: "Tất cả quầy",
    slot: "Slot",
  ...
  zh: {
    ...
    filters: "筛选",
    clearFilters: "清除筛选",
    productSearch: "按名称、编码、条码、材质、描述搜索...",
    category: "分类",
    allCategories: "全部分类",
    productType: "商品类型",
    allTypes: "全部类型",
...
export const VOUCHER_EXCEL_IMPORT_TEXT = {
  vi: {
    ...
    downloadingTemplate: "Đang tạo mẫu...",
    templateDownloaded: "Đã tải file Excel mẫu",
    templateDownloadFailed: "Không thể tạo file Excel mẫu",
  ...
  zh: {
    ...
    templateDownloadFailed: "无法生成 Excel 模板",
...
export const PROCESS_CONFIG_TEXT = {
  vi: {
    ...
    createWarehouseConfig: "Tạo cấu hình theo kho",
    createWarehouseConfigHint:
      "Tạo một bản cấu hình riêng cho kho đã chọn từ cấu hình mặc định hiện tại.",
    selectWarehouse: "Chọn kho",
    selectEntityType: "Chọn nghiệp vụ",
    warehouseConfigExists: "Kho này đã có cấu hình riêng",
    save: "Lưu cấu hình",
    saving: "Đang lưu...",
    ...
    approvalScope: "Phạm vi duyệt",
    entityWarehouseScope: "Kho của chứng từ",
    sourceWarehouseScope: "Kho nguồn",
    destinationWarehouseScope: "Kho đích",
    globalRoleScope: "Role toàn hệ thống",
    allowGlobalFallback: "Cho phép role global xử lý thay",
    assignee: "Người xử lý",
    assignmentScope: "Phạm vi xử lý",
  ...
  zh: {
    ...
    createWarehouseConfig: "创建仓库配置",
    createWarehouseConfigHint: "从当前默认配置为所选仓库创建一份专属配置。",
    selectWarehouse: "选择仓库",
    selectEntityType: "选择业务类型",
    warehouseConfigExists: "该仓库已有专属配置",
    save: "保存配置",
    saving: "保存中...",
    addLevel: "添加审批级别",
    removeLevel: "删除审批级别",
    ...
    approvers: "审批人数",
    approvalScope: "审批范围",
    entityWarehouseScope: "单据仓库",
    sourceWarehouseScope: "来源仓库",
    destinationWarehouseScope: "目标仓库",
    globalRoleScope: "全系统角色",
    allowGlobalFallback: "允许全系统角色代处理",
    assignee: "处理人",
    assignmentScope: "处理范围",
    creator: "单据创建人",
    selectedRole: "指定角色",
