...
const vi = {
    ...
    receiving: {
        ...
        barcodeNoMatch: "Mã vạch '{{barcode}}' không khớp với sản phẩm nào trong phiếu.",
        ...
        confirmStatement: "Tôi đã kiểm đếm kỹ lưỡng từng sản phẩm và chịu mọi trách nhiệm về tính chính xác của số liệu thực nhận.",
        ...
        reviewDescription: "Rà lại danh sách hàng, số lượng thực nhận và chênh lệch trước khi hoàn tất.",
        ...
        submitSuccessDescription: "Số liệu thực nhận đã được lưu và quy trình đã tiếp tục.",
    ...
    pickingSession: {
        ...
        confirmStatement: "Tôi đã kiểm tra kỹ từng mặt hàng, số lượng đã soạn và chấp nhận trách nhiệm với số liệu xuất kho này.",
        attentionItems: "Mục cần soát",
        reviewTitle: "Xác nhận trước khi hoàn tất soạn hàng",
        reviewDescription: "Kiểm tra lại danh sách hàng, số lượng đã soạn và chênh lệch trước khi trừ tồn.",
        ...
        submitValidationDescription: "Vui lòng nhập số lượng đã soạn cho ít nhất một sản phẩm.",
        submitting: "Đang hoàn tất soạn hàng & trừ tồn kho...",
        submitSuccess: "Soạn hàng hoàn tất",
        submitError: "Lỗi hoàn tất soạn hàng",
        submitSuccessDescription: "Tồn kho đã được trừ. Phiếu chuyển sang trạng thái Đã bàn giao.",
        submitErrorDescription: "Không đủ tồn kho hoặc lỗi hệ thống. Vui lòng kiểm tra lại.",
...
Object.assign(vi, {
    ...
    externalQueue: {
        ...
        pendingTab: {
            ...
            autoSubmitSuccessDesc: "Các hàng chờ đã qua ngưỡng thời gian được chuyển sang chờ duyệt.",
        ...
        detailDrawer: {
            ...
            messages: {
                ...
                adjustReason: "Điều chỉnh từ {{from}} sang {{to}} trên hàng chờ {{batchId}}",
                ...
                cancelScanSuccessDesc: "Tồn ATP đã được hoàn lại và hành động đã ghi audit log.",
            ...
            hints: {
                canEdit: "Người có quyền có thể chỉnh số lượng từng dòng. Mỗi lần lưu sẽ ghi audit log.",
                queuedNote: "Hàng chờ này đang theo quầy và sẽ được auto-submit. Nhân viên chỉ quét; chỉ người có quyền mới được sửa hoặc hủy dòng.",
                unsavedChanges: "Còn thay đổi số lượng chưa lưu. Hãy lưu từng dòng trước khi duyệt.",
                queuedApproveNote: "Hàng chờ đang quét không submit thủ công tại màn hình này. Hệ thống sẽ auto-submit theo quầy, sau đó admin có thể duyệt xuất kho.",
