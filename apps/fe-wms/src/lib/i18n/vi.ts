...
const vi = {
    nav: {
        ...
        processConfigs: "Quy trình duyệt",
        notification: "Gửi hông báo",
        expenses: "Báo cáo chi phí",
        revenueManagement: "Quản lý doanh thu",
        invoiceManagement: "Quản lý hóa đơn",
        attendance: "Chấm công",
        employeeAdmin: "Cổng hành chính",
        expenseDashboard: "Quản lý chi phí",
        expenseEntry: "Nhập liệu chi phí",
        externalQueue: "Hệ thống ngoài",
        more: "Thêm",
    },
    ...
    auditLog: {
        ...
        entityLabels: {
            ...
            roles: "Role",
            users: "Người dùng",
            leave_import_batches: "Đợt nhập lịch sử nghỉ phép",
            leave_import_rows: "Dòng nhập lịch sử nghỉ phép",
        },
        pageLabels: {
            ...
            leave_import_batches: "Hành chính nhân sự",
            leave_import_rows: "Hành chính nhân sự",
        },
    },
    ...
    tasks: {
        ...
        detail: {
            ...
            importCounter: "Quầy nhập",
            exportCounter: "Quầy xuất",
            supplier: "Nhà cung cấp",
    ...
    employeeManagement: {
        ...
        fields: {
            ...
            officialStartDate: "Bắt đầu chính thức",
    ...
    marketingVouchers: {
        ...
        overview: {
            lifecycle: "Phân bổ trạng thái mã",
            ...
            remaining: "Còn lại",
            used: "Đã dùng",
            ofInventory: "trên tổng kho",
            availableHint: "khả dụng",
            afterIssue: "sau phát",
            issuedRate: "Tỷ lệ phát",
            issuedRateHint: "Đã phát trên tổng kho",
            usageRate: "Tỷ lệ sử dụng",
            usageRateHint: "Đã dùng trên số đã phát",
            availabilityRate: "Tồn khả dụng",
            availabilityRateHint: "Còn có thể phát",
            distributedUnused: "Đã phát chưa dùng",
            revoked: "Bị thu hồi",
            duration: "Thời lượng chiến dịch",
            days: "ngày",
            inventoryStatus: "Tình trạng tồn mã",
            health: {
                HEALTHY: "Còn mã",
                LOW: "Sắp hết mã",
                EMPTY: "Đã hết mã",
        ...
        campaigns: {
            ...
            empty: "Chưa có chiến dịch voucher.",
            emptyHint: "Tạo chiến dịch đầu tiên để bắt đầu sinh mã.",
            search: "Tìm theo tên chiến dịch...",
            purpose: "Mục đích",
            status: "Trạng thái",
            validity: "Thời hạn",
            codes: "Số mã",
        ...
        appearance: {
            ...
            preview: "Xem trước mẫu cố định",
            save: "Lưu màu",
            hint: "Logo, bố cục, phông chữ và QR được JPULSE tự động quản lý.",
        },
        form: {
            createTitle: "Tạo chiến dịch voucher",
            editTitle: "Cập nhật chiến dịch",
            name: "Tên chiến dịch",
            description: "Mô tả",
            rewardType: "Loại ưu đãi",
            rewardValue: "Giá trị ưu đãi",
            validFrom: "Hiệu lực từ",
            validTo: "Hiệu lực đến",
            prefix: "Tiền tố",
            codeLength: "Độ dài phần ngẫu nhiên",
            suffix: "Hậu tố",
            purpose: "Mục đích",
            ...
            invalidDate: "Ngày hết hạn phải bằng hoặc sau ngày bắt đầu.",
            unsafeCodeSpace: "Độ dài mã quá ngắn cho số lượng đã chọn.",
        },
        action: {
        ...
        codes: {
            ...
            search: "Nhập chính xác mã voucher...",
            campaign: "Chiến dịch",
            status: "Trạng thái",
            reward: "Ưu đãi",
            validTo: "Hết hạn",
            ...
            empty: "Không tìm thấy mã phù hợp.",
            previous: "Trang trước",
            next: "Trang sau",
            page: "Trang",
            email: "Gửi email",
        ...
        email: {
            ...
            stepCompose: "Nội dung",
            selected: "Voucher đã chọn",
            grouped: "Gộp voucher vào một email",
            groupedHint: "Một người nhận nhận toàn bộ voucher đã chọn.",
            individual: "Mỗi voucher một email",
            individualHint: "Nhập email riêng cho từng mã voucher.",
            recipient: "Email người nhận",
            recipientFor: "Người nhận mã",
            ...
            back: "Quay lại",
            queue: "Xác nhận gửi",
            oneCampaign: "Chỉ có thể gửi voucher thuộc cùng một chiến dịch.",
            activeOnly: "Chiến dịch phải hoạt động để gửi email.",
            invalidEmails: "Vui lòng nhập email hợp lệ cho mọi voucher.",
        },
        jobs: {
            title: "Lịch sử công việc nền",
            campaign: "Chiến dịch",
            type: "Loại job",
            progress: "Tiến độ",
            attempts: "Số lần chạy",
            requestedAt: "Khởi tạo",
            error: "Lỗi gần nhất",
            resume: "Tiếp tục job",
        ...
        emailResults: {
            ...
            attempts: "Lần gửi",
            error: "Chi tiết lỗi",
            retryFailed: "Gửi lại email lỗi",
            noItems: "Chưa có kết quả email.",
        },
        purpose: { EVENT: "Sự kiện", PRINT: "In ấn" },
        rewardType: {
        ...
        campaignStatus: {
            GENERATING: "Đang sinh mã",
            ACTIVE: "Hoạt động",
            PAUSED: "Tạm dừng",
            ENDED: "Đã kết thúc",
            GENERATION_FAILED: "Sinh mã lỗi",
        },
        codeStatus: {
            AVAILABLE: "Sẵn sàng",
            DISTRIBUTED: "Đã phát",
...
Object.assign(vi, {
    employeeAdmin: {
        ...
        usedLeave: "Đã dùng",
        probationLeave: "Đang khóa thử việc",
        expiredLeave: "Đã hết hạn",
        balanceAsOf: "Số dư đến ngày {date}",
        viewLeaveHistory: "Xem lịch sử ngày phép",
        leaveHistoryTitle: "Lịch sử ngày phép",
        leaveHistoryHint:
            "Mỗi thay đổi số dư được lưu thành một bút toán và không bị ghi đè.",
        leaveLedgerEmpty: "Chưa có bút toán ngày phép",
        leaveBalanceNoAccess: "Bạn chưa có quyền xem số dư ngày phép cá nhân.",
        leaveBalanceLoadError: "Không thể tải số dư ngày phép.",
        leaveYear: "Phép năm {year}",
        monthlyAccrual: "Cộng phép hằng tháng",
        probationAccrual: "Cộng phép đang khóa trong thử việc",
        probationRelease: "Mở khóa phép sau thử việc",
        requestHold: "Tạm giữ cho đơn nghỉ phép",
        requestApproved: "Xác nhận phép đã dùng",
        requestReleased: "Hoàn lại phép tạm giữ",
        yearEndExpired: "Ngày phép hết hạn",
        historicalImport: "Lịch sử trừ phép",
        manualAdjustment: "Điều chỉnh ngày phép",
        leaveBalanceHint:
            "Phép thử việc được tích lũy vào ngày 15 và chỉ khả dụng sau khi chuyển chính thức.",
        carryoverLeaveExpiry: "Phép năm trước hết hạn ngày {date}",
        adminRequests: "Yêu cầu hành chính",
        quickActions: "Tạo yêu cầu nhanh",
        createRequest: "Tạo yêu cầu",
        createRequestHint:
            "Chọn từng ngày hoặc nửa ngày cần nghỉ và gửi đến cấp duyệt.",
        paidLeave: "Xin nghỉ phép",
        workFromHomeRequest: "Làm việc tại nhà",
        unpaidLeave: "Nghỉ không phép",
        maternityLeave: "Nghỉ thai sản",
        sickLeave: "Nghỉ bệnh",
        requestActionHint: "Mở biểu mẫu",
        workFromHomeDateRule:
            "Chọn các ngày làm việc tại nhà; yêu cầu WFH áp dụng theo nguyên ngày.",
        totalWorkFromHomeDays: "{units} ngày WFH",
        ...
        selectedLeaveDates: "Các ngày cần nghỉ",
        leaveDateRule:
            "Mỗi đơn chỉ có tối đa một khoảng ngắt; khoảng cách không quá 2 ngày.",
        totalLeaveUnits: "{units} ngày",
        leaveDate: "Ngày nghỉ",
        leavePortion: "Thời lượng nghỉ",
        fullDay: "Cả ngày",
        morning: "Buổi sáng",
        afternoon: "Buổi chiều",
        removeDate: "Bỏ ngày đã chọn",
        addLeaveDate: "Thêm ngày nghỉ",
        invalidLeaveSelection: "Ngày nghỉ chưa hợp lệ",
        selectAtLeastOneDate: "Vui lòng chọn ít nhất một ngày nghỉ.",
        duplicateLeaveDate:
            "Một ngày không thể xuất hiện hai lần trong cùng đơn.",
        weekendNotAllowed: "Không thể đăng ký nghỉ vào ngày cuối tuần.",
        holidayNotAllowed: "Không thể đăng ký nghỉ vào ngày lễ của công ty.",
        gapTooWide: "Khoảng cách giữa hai ngày đã chọn không được quá 2 ngày.",
        tooManyGaps: "Mỗi đơn chỉ được có một khoảng ngắt giữa các ngày nghỉ.",
        reasonRequired: "Chưa nhập lý do",
        reasonRequiredHint: "Vui lòng nhập lý do trước khi lưu hoặc gửi đơn.",
        saveDraft: "Lưu nháp",
        submitRequest: "Gửi duyệt",
        savingDraft: "Đang lưu đơn nháp...",
        submittingRequest: "Đang gửi đơn nghỉ phép...",
        saveDraftSuccess: "Đã lưu đơn nháp",
        saveDraftSuccessHint:
            "Bạn có thể gửi duyệt đơn này từ lịch sử yêu cầu.",
        submitRequestSuccess: "Đã gửi đơn nghỉ phép",
        submitRequestSuccessHint:
            "Số ngày phép liên quan đã được tạm giữ trong lúc chờ duyệt.",
        leaveRequestSaveError: "Không thể lưu đơn nghỉ phép",
        leaveRequestSaveErrorHint:
            "Vui lòng kiểm tra số dư, cấu hình duyệt hoặc thử lại sau.",
        leaveRequestsLoadError: "Không thể tải lịch sử xin nghỉ phép.",
        holidaysLoadError: "Không thể tải danh sách ngày lễ.",
        holidaySaveError: "Không thể cập nhật ngày lễ.",
        retry: "Thử lại",
        requestHistoryTitle: "Lịch sử xin nghỉ phép",
        requestHistoryHint:
            "Theo dõi đơn nháp, tiến độ duyệt và các đơn đã hoàn tất theo thời gian thực.",
        filterLeaveStatus: "Lọc theo trạng thái",
        filterLeaveType: "Lọc theo loại nghỉ",
        allStatuses: "Tất cả trạng thái",
        allLeaveTypes: "Tất cả loại nghỉ",
        noFilterResults: "Không có đơn phù hợp với bộ lọc hiện tại.",
        viewRequestHistory: "Xem toàn bộ lịch sử yêu cầu",
        leaveStatusDraft: "Nháp",
        leaveStatusPending: "Chờ duyệt",
        leaveStatusApproved: "Đã duyệt",
        leaveStatusRejected: "Từ chối",
        leaveStatusCancelled: "Đã hủy",
        leaveStatusApproverUnavailable: "Thiếu người duyệt",
        cancelRequest: "Hủy đơn",
        cancelReasonPlaceholder: "Nhập lý do hủy đơn...",
        confirmCancelRequest: "Xác nhận hủy",
        back: "Quay lại",
        cancellingRequest: "Đang hủy đơn...",
        cancelRequestSuccess: "Đã hủy đơn nghỉ phép",
        cancelRequestSuccessHint: "Số dư đang giữ đã được hoàn trả.",
        manageCompanyHolidays: "Quản lý ngày lễ công ty",
        manageCompanyHolidaysHint:
            "Ngày lễ áp dụng toàn công ty và được loại khỏi các ngày có thể xin nghỉ.",
        addCompanyHoliday: "Thêm ngày lễ",
        holidayDate: "Ngày lễ",
        holidayNameVi: "Tên ngày lễ bằng tiếng Việt",
        holidayNameZh: "Tên ngày lễ bằng tiếng Trung",
        savingHoliday: "Đang lưu ngày lễ...",
        saveHolidaySuccess: "Đã thêm ngày lễ",
        saveHolidaySuccessHint: "Ngày này đã được áp dụng cho toàn công ty.",
        removingHoliday: "Đang ngừng áp dụng ngày lễ...",
        removeHolidaySuccess: "Đã ngừng áp dụng ngày lễ",
        removeHolidaySuccessHint:
            "Ngày này có thể được chọn trong đơn nghỉ phép mới.",
        holidaySaveErrorHint: "Vui lòng kiểm tra quyền hoặc thử lại sau.",
        removeHoliday: "Ngừng áp dụng ngày lễ",
        noCompanyHolidays: "Chưa có ngày lễ công ty",
        noCompanyHolidaysHint:
            "Thêm ngày lễ để hệ thống loại trừ khi nhân viên chọn ngày nghỉ.",
        approvalConfigTitle: "Cấu hình duyệt nghỉ phép",
        approvalConfigHint:
            "Bật tối đa 3 cấp duyệt tuần tự và chọn role hoặc người duyệt cụ thể cho từng cấp.",
        approvalInboxTitle: "Đơn nghỉ phép chờ tôi duyệt",
        approvalInboxHint: "Mỗi cấp chỉ được mở sau khi cấp trước đã duyệt.",
        approvalUnavailableTitle: "Đơn thiếu người duyệt",
        approvalUnavailableHint:
            "HR phải chỉ định lại người hoặc role có quyền; hệ thống không tự động chuyển về role.",
        approvalLoadError: "Không thể tải dữ liệu duyệt nghỉ phép.",
        approvalSaveError: "Không thể cập nhật duyệt nghỉ phép.",
        approvalAtLeastOneLevel: "Phải bật ít nhất 1 cấp duyệt",
        approvalAtLeastOneLevelHint: "Hãy bật một cấp trước khi lưu cấu hình.",
        approvalNoEligibleOptions:
            "Chưa có role hoặc người dùng nào đang có quyền duyệt nghỉ phép.",
        approvalLevel: "Cấp duyệt {level}",
        approvalLevelEnabled: "Đang áp dụng",
        approvalLevelDisabled: "Đã tắt",
        approvalToggleLevel: "Bật hoặc tắt cấp duyệt",
        approvalByRole: "Duyệt theo role",
        approvalByUser: "Chỉ định người duyệt",
        approvalConfigSave: "Lưu cấu hình duyệt",
        approvalConfigSaving: "Đang lưu cấu hình duyệt...",
        approvalConfigSaved: "Đã lưu cấu hình duyệt",
        approvalInboxEmpty: "Không có đơn đang chờ bạn duyệt",
        approvalInboxEmptyHint:
            "Đơn mới sẽ xuất hiện theo thời gian thực khi đến cấp của bạn.",
        approvalDecisionReasonPlaceholder:
            "Ghi chú duyệt; bắt buộc khi từ chối...",
        approvalRejectReasonRequired: "Vui lòng nhập lý do từ chối.",
        approvalDecisionSaving: "Đang cập nhật quyết định...",
        approvalApproved: "Đã duyệt đơn nghỉ phép",
        approvalRejected: "Đã từ chối đơn nghỉ phép",
        approvalApprove: "Duyệt",
        approvalReject: "Từ chối",
        leaveUnitShort: "ngày",
        approvalUnavailableEmpty: "Không có đơn thiếu người duyệt",
        approvalUnavailableEmptyHint:
            "Các đơn có người duyệt mất hiệu lực sẽ xuất hiện tại đây.",
        approvalReassignReasonPlaceholder: "Lý do chỉ định lại người duyệt...",
        approvalReassignRequired:
            "Hãy chọn người/role và nhập lý do chỉ định lại.",
        approvalReassigning: "Đang chỉ định lại người duyệt...",
        approvalReassigned: "Đã chỉ định lại người duyệt",
        approvalReassign: "Chỉ định lại",
        localeCode: "vi",
        approvalTimelineEmpty: "Đơn này chưa có tiến trình duyệt.",
        approvalLevelLabel: "Cấp {level} · {label}",
        approvalStatusWaiting: "Chờ cấp trước",
        approvalStatusPending: "Đang chờ duyệt",
        approvalStatusApproved: "Đã duyệt",
        approvalStatusRejected: "Đã từ chối",
        approvalStatusCancelled: "Đã hủy",
        approvalStatusUnavailable: "Thiếu người duyệt",
        previousMonth: "Tháng trước",
        nextMonth: "Tháng sau",
        calendarMonthLabel: "Tháng {month}/{year}",
        calendarWeekdays: "CN,T2,T3,T4,T5,T6,T7",
        companyHoliday: "Ngày lễ công ty",
        selectLeaveDatesHint:
            "Chạm vào từng ngày trên lịch để chọn; cuối tuần và ngày lễ đã bị khóa.",
        leaveAdministrationLoadError:
            "Không thể tải dữ liệu quản trị ngày phép.",
        leaveAdministrationSaveError:
            "Không thể cập nhật dữ liệu quản trị ngày phép.",
        leaveAdministrationSaveErrorHint:
            "Vui lòng kiểm tra quyền, số dư và thử lại.",
        leavePolicyTitle: "Chính sách ngày phép",
        leavePolicyHint:
            "Cấu hình mức tích lũy và giới hạn phép dùng chung toàn công ty.",
        monthlyAccrualUnits: "Số ngày cộng mỗi tháng",
        annualLeaveCap: "Giới hạn ngày phép mỗi năm",
        leavePolicyFixedRules:
            "Ngày cộng phép cố định là ngày 15; phép năm cũ hết hạn sau 31/03; phép thử việc luôn được khóa đến khi chính thức.",
        saveLeavePolicy: "Lưu chính sách",
        leavePolicySaving: "Đang lưu chính sách ngày phép...",
        leavePolicySaved: "Đã lưu chính sách ngày phép",
        leavePolicySavedHint: "Chính sách mới áp dụng cho toàn công ty.",
        companyLeaveRequestsTitle: "Đơn nghỉ phép toàn công ty",
        companyLeaveRequestsHint:
            "Theo dõi đơn trong phạm vi được phân quyền và tiến trình duyệt theo thời gian thực.",
        searchEmployeeLeave: "Tìm theo tên hoặc mã nhân viên",
        employeeSearchEmpty: "Không tìm thấy nhân viên phù hợp.",
        noCompanyLeaveRequests: "Chưa có đơn nghỉ phép",
        noCompanyLeaveRequestsHint:
            "Đơn mới trong phạm vi của bạn sẽ tự động xuất hiện.",
        leaveBalanceAdjustmentTitle: "Điều chỉnh số dư ngày phép",
        leaveBalanceAdjustmentHint:
            "Tạo bút toán điều chỉnh có lý do; lịch sử cũ không bị ghi đè.",
        selectEmployee: "Chọn nhân viên",
        postingDate: "Ngày ghi nhận",
        adjustmentUnits: "Số ngày +/-",
        adjustmentReason: "Nhập lý do điều chỉnh...",
        confirmLeaveAdjustment: "Xác nhận điều chỉnh",
        adjustingLeaveBalance: "Đang điều chỉnh số dư...",
        leaveBalanceAdjusted: "Đã điều chỉnh số dư",
        leaveBalanceAdjustedHint: "Bút toán và số dư đã được cập nhật.",
        leaveStatusDRAFT: "Nháp",
        leaveStatusPENDING_APPROVAL: "Chờ duyệt",
        leaveStatusAPPROVED: "Đã duyệt",
        leaveStatusREJECTED: "Từ chối",
        leaveStatusCANCELLED: "Đã hủy",
        leaveStatusAPPROVER_UNAVAILABLE: "Thiếu người duyệt",
        leaveTypePAID_ANNUAL: "Nghỉ phép năm",
        leaveTypeWORK_FROM_HOME: "Làm việc tại nhà",
        leaveTypeUNPAID: "Nghỉ không phép",
        leaveTypeSICK: "Nghỉ bệnh",
        leaveTypeMATERNITY: "Nghỉ thai sản",
        leaveImportLocale: "vi",
        leaveImportTitle: "Nhập lịch sử nghỉ phép",
        leaveImportHint:
            "Nhập trực tiếp trên giao diện hoặc dùng Excel; luôn xem trước lỗi trước khi ghi nhận.",
        leaveImportManualTab: "Nhập thủ công",
        leaveImportExcelTab: "Nhập bằng Excel",
        leaveImportManualTitle: "Nhập lịch sử trực tiếp",
        leaveImportManualHint:
            "Chọn một nhân viên và nhiều ngày nghỉ; hệ thống tạo một bản ghi cho từng ngày.",
        leaveImportManualReason: "Nhập lý do hoặc ghi chú cho các ngày nghỉ...",
        leaveImportManualPreview: "Kiểm tra và xem trước",
        leaveImportManualPreviewing: "Đang kiểm tra dữ liệu nhập thủ công...",
        leaveImportManualBatchName: "Nhập thủ công",
        leaveImportLoadError: "Không thể tải lịch sử nhập dữ liệu.",
        leaveImportSaveError: "Không thể xử lý tệp lịch sử nghỉ phép.",
        leaveImportInvalidFile: "Tệp không hợp lệ",
        leaveImportInvalidFileType: "Chỉ chấp nhận tệp Excel định dạng .xlsx.",
        leaveImportFileTooLarge: "Tệp Excel không được vượt quá 10MB.",
        leaveImportSelectFile: "Chuẩn bị dữ liệu lịch sử",
        leaveImportSelectFileHint:
            "Mỗi tệp tối đa 100 dòng; hệ thống kiểm tra lại trực tiếp từ tệp đã tải lên.",
        leaveImportDownloadTemplate: "Tải tệp mẫu",
        leaveImportChooseFile: "Chọn tệp Excel đã chuẩn bị",
        leaveImportTemplateGenerating: "Đang tạo tệp mẫu...",
        leaveImportTemplateReady: "Đã tải tệp mẫu",
        leaveImportTemplateReadyHint:
            "Điền dữ liệu theo sheet Guide rồi tải lại lên hệ thống.",
        ...
        leaveImportPreviewReadyHint:
            "Hãy kiểm tra tất cả dòng trước khi ghi nhận.",
        leaveImportPreviewError: "Không thể xem trước tệp",
        leaveImportTotalRows: "Tổng dòng",
        leaveImportValidRows: "Hợp lệ",
        leaveImportInvalidRows: "Có lỗi",
        leaveImportReadyToCommit: "Tất cả dòng hợp lệ và sẵn sàng ghi nhận.",
        leaveImportAlreadyCommitted: "Đã ghi nhận",
        leaveImportFixInvalidRows:
            "Hãy sửa các dòng lỗi trong biểu mẫu hoặc Excel và tạo bản xem trước mới.",
        leaveImportRecordType: "Loại dữ liệu",
        leaveImportPostingDate: "Ngày ghi nhận",
        leaveImportUnits: "Số ngày",
        leaveImportValidation: "Kiểm tra",
        leaveImportValid: "Hợp lệ",
        leaveImportCommit: "Ghi nhận lịch sử",
        leaveImportCommitting: "Đang ghi nhận lịch sử...",
        leaveImportCommitted: "Đã ghi nhận lịch sử nghỉ phép",
        leaveImportCommittedHint:
            "Đơn lịch sử, số dư và audit đã được cập nhật.",
        leaveImportCommitError: "Không thể hoàn tất ghi nhận",
        leaveImportBatchHistory: "Các lần nhập gần đây",
        leaveImportLoadingBatch: "Đang tải chi tiết lần nhập...",
        leaveImportBatchLoaded: "Đã tải chi tiết lần nhập",
        leaveImportBatchLoadedHint: "Bản xem trước đã sẵn sàng để kiểm tra.",
        leaveImportStatusPreviewed: "Đã xem trước",
        leaveImportStatusCommitting: "Đang ghi nhận",
        leaveImportStatusCommitted: "Hoàn tất",
        leaveImportStatusFailed: "Cần thử lại",
        leaveImportStatusCancelled: "Đã hủy",
    },
    attendance: {
        checkInWithGps: "Check-in bằng định vị",
        gpsCheckInHint:
            "Trình duyệt chỉ xin quyền và ghi nhận vị trí một lần khi check-in.",
        verificationStrategy: "Phương thức xác thực",
        ipOnly: "Chỉ mạng công ty",
        gpsOnly: "Chỉ định vị GPS",
        ipOrGps: "Mạng công ty hoặc GPS",
        ipAndGps: "Mạng công ty và GPS",
        gpsRadius: "Bán kính (m)",
        gpsAccuracy: "Sai số tối đa (m)",
        gpsAge: "Tuổi vị trí (giây)",
        allowBusinessTrip: "Cho phép chấm công khi đi công tác",
        allowWorkFromHome: "Cho phép chấm công Work from home",
        missingWarehouseCoordinate:
            "Cơ sở chưa có tọa độ. Hãy cập nhật tọa độ trước khi dùng geofence GPS.",
        workArrangementTitle: "Lịch công tác và Work from home",
        workArrangementHint:
            "Cấu hình có hiệu lực ngay; người tạo không thể tự duyệt cho chính mình.",
        selectEmployee: "Chọn nhân viên",
        workMode: "Hình thức",
        ...
        toDate: "Đến ngày",
        reason: "Lý do",
        workReasonPlaceholder: "Ví dụ: Công tác tại Hà Nội / WFH theo lịch...",
        destinationGeofence: "Giới hạn tại điểm đến",
        destinationName: "Tên điểm đến",
        latitude: "Vĩ độ",
        longitude: "Kinh độ",
        saveWorkArrangement: "Lưu và duyệt lịch",
        cancelWorkArrangement: "Hủy lịch",
        workArrangementValidation:
            "Hãy chọn nhân viên và nhập lý do tối thiểu 4 ký tự.",
        coordinateInvalid: "Tọa độ điểm công tác/WFH không hợp lệ.",
        savingWorkArrangement: "Đang lưu lịch làm việc...",
        savedWorkArrangement: "Đã lưu và duyệt lịch làm việc.",
        saveWorkArrangementError: "Không thể lưu lịch làm việc.",
        savedWorkArrangementDesc:
            "Lịch có hiệu lực ngay trong khoảng ngày đã chọn.",
        saveWorkArrangementErrorDesc:
            "Vui lòng kiểm tra dữ liệu, quyền truy cập và thử lại.",
        cancellingWorkArrangement: "Đang hủy lịch làm việc...",
        cancelledWorkArrangement: "Đã hủy lịch làm việc.",
        cancelWorkArrangementError: "Không thể hủy lịch làm việc.",
        cancelledWorkArrangementDesc:
            "Lịch đã được hủy nhưng vẫn được giữ trong audit log.",
        title: "Chấm công",
        subtitle:
        ...
        blankMeansNoCheckIn:
            "Dot màu thể hiện check-in hoặc loại nghỉ đã được duyệt.",
        leaveOnCalendar: "Ngày nghỉ",
        leaveTypePAID_ANNUAL: "Nghỉ phép năm",
        leaveTypeWORK_FROM_HOME: "Work from home",
        leaveTypeUNPAID: "Nghỉ không phép",
        leaveTypeSICK: "Nghỉ bệnh",
        leaveTypeMATERNITY: "Nghỉ thai sản",
        leaveStatusPENDING_APPROVAL: "Chờ duyệt",
    ...
    externalQueue: {
        ...
        pendingTab: {
            ...
            sku: "SKU",
            quantityShort: "SL",
            nextApproval: "Cấp duyệt tiếp theo",
            approvalLevel: "Cấp",
            approvedProgress: "đã duyệt",
            money: "Tiền",
            open: "Mở",
            scanning: "Đang quét",
            readOnly: "Chỉ xem",
