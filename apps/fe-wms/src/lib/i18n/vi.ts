...
const vi = {
    ...
    revenue: {
        ...
        subtitle: "Dashboard doanh thu JoyWorld cho cửa hàng B.Duck Cityfuns Landmark 81.",
        ...
        charts: {
            ...
            revenueSubtitle: "Cột là doanh thu, đường là xu hướng; ngày được chọn sẽ đổi màu.",
            ...
            memberCardSubtitle: "Tổng tiền bán/nạp thẻ thành viên theo ngày hiển thị.",
        ...
        orders: {
            ...
            subtitle: "Chuyển đổi giữa danh sách đơn hàng và danh sách sản phẩm theo đơn.",
            tabs: {
    ...
    warehouses: {
        ...
        mappingInstruction: "Kéo sản phẩm từ nhóm chưa gán vào giải để mapping bố cục trong vị trí.",
        ...
        webglErrorDesc: "Trình duyệt của bạn không hỗ trợ WebGL hoặc tính năng tăng tốc phần cứng (Hardware Acceleration) đang bị tắt. Vui lòng bật nó trong cài đặt trình duyệt để xem bản đồ.",
    ...
    tasks: {
        ...
        workbench: {
            ...
            emptySessionHint: "Các lệnh đã duyệt và chờ nhập/soạn/nhận sẽ hiển thị tại đây.",
            emptyCompletionTitle: "Không có phiếu cần hoàn thành",
            emptyCompletionHint: "Các phiếu xuất đã ship sẽ hiển thị tại đây để hoàn tất.",
        ...
        nonconformity: {
            ...
            notesPlaceholder: "Nhập ghi chú xử lý, biện pháp khắc phục hoặc căn cứ quyết định...",
            ...
            toast: {
                ...
                resolveSuccessDesc: "Tồn kho liên quan đã được cập nhật theo quyết định xử lý.",
                resolveErrorDesc: "Vui lòng kiểm tra quyền, trạng thái báo cáo hoặc thử lại sau.",
            },
        },
        filters: {
            all: "Tất cả",
