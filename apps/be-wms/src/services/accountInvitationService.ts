...
export const sendInitialPasswordSetupInvitation = async (
  ...
  try {
    await sendBrevoEmail({
      to: [user.email],
      subject: "Kích hoạt tài khoản Joy World WMS",
      htmlContent: `
        <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111827">
          <h2>Kích hoạt tài khoản Joy World WMS</h2>
          <p>Xin chào ${safeName},</p>
          <p>Tài khoản của bạn đã được tạo trên hệ thống Joy World WMS.</p>
      ...
      textContent: [
        ...
        "Tài khoản của bạn đã được tạo trên hệ thống Joy World WMS.",
