  ...
  for (const record of records) {
    ...
    if (!groups.has(key)) {
      groups.set(key, {
        ...
        work_shift_date: record.shift_date ?? date,
        access_session_id: record.access_session_id ?? null,
        handover_to_session_id: record.handover_to_session_id ?? null,
        queue_date: date,
    ...
    group.items.push({
      ...
      shift_id: record.shift_id ?? null,
      shift_date: record.shift_date ?? date,
      access_session_id: record.access_session_id ?? null,
      rejection_reason: record.rejection_reason,
      notes: record.notes,
    });
