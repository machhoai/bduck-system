...
const ENTITY_COLLECTION_MAP: Record<string, string> = {
  ...
  leave_import_batches: "leave_import_batches",
  leave_import_rows: "leave_import_rows",
  leave_reconciliation_runs: "leave_reconciliation_runs",
  expenses: "expenses",
  notification_dispatches: "notification_dispatches",
  account_invitations: "account_invitations",
  file_templates: "file_templates",
  file_template_bundles: "file_template_bundles",
  ...
  MEINVOICE_ACCOUNT: "meinvoice_accounts",
  MEINVOICE_STORE_CONFIG: "meinvoice_store_configs",
  INVOICE_ORDER_SYNC_RUN: "invoice_order_sync_runs",
  INVOICE_RECONCILIATION_RUN: "invoice_reconciliation_runs",
  INVOICE_RECONCILIATION_CASE: "invoice_reconciliation_cases",
