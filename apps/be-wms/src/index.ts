...
import internalStockCountRoutes from "./api/routes/internalStockCountRoutes.js";
...
import partnerInventoryRoutes from "./api/routes/partnerInventoryRoutes.js";
...
app.use("/api/stock-counts", internalStockCountRoutes);
...
app.use("/api/employee-contract-imports", employeeContractImportRoutes);
app.use("/api/employee-contracts", employeeContractAutomationRoutes);
...
app.use("/api/partner-inventory", partnerInventoryRoutes);
